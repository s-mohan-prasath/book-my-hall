            ...
            <div className="features-container">
                ...
                <div className="features">
                    <div className="feature-card">
                        <img src="images/booking.jpeg" alt="Feature 1" className="feature-image" />
                    ...
                    <div className="feature-card">
                        <img src="images/event.jpeg" alt="Feature 2" className="feature-image" />
                        <div className="feature-content">
                    ...
                    <div className="feature-card">
                        <img src="images/ed.jpeg" alt="Feature 3" className="feature-image" />
                        <div className="feature-content">
